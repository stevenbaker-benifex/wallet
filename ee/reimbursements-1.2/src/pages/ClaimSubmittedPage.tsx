...
function StatusBanner() {
  return (
    <div className="flex items-start gap-3 rounded-xl border border-[#3AAB52] bg-[#F0FAF2] px-4 py-3">
      <i className="fa-regular fa-circle-check mt-0.5 text-brand-oregon" aria-hidden />
      <div className="flex flex-col gap-0.5">
        <p className="font-heading text-xl font-semibold leading-[1.2] text-grey-90">Claim submitted</p>
        <p className="font-body text-sm leading-[21px] tracking-wide text-grey-70">
          You'll receive an email when this has been reviewed.{' '}&nbsp;
          <Link to="/get-reimbursed" className="underline underline-offset-2 hover:text-grey-90">
  ...
  return (
    <AppShell activeNav="wallet">
      ...
      <div className="flex min-h-screen flex-col bg-grey-02 lg:hidden">
        ...
        <Link to="/" className="inline-flex h-9 items-center justify-center rounded-full bg-brand-oregon px-5 font-button text-sm text-white">Done</Link>

          <button
            type="button"
            className="font-body text-base leading-6 tracking-wide text-grey-90 underline underline-offset-2 hover:text-[#AE0000] cursor-pointer"
          >
            Cancel claim
          </button>
        </div>
